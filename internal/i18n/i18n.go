...
var messages = map[Language]map[string]string{
	JA: {
		...
		"latency": "レイテンシ", "searchWork": "探索量", "selection": "前後探索比率", "regret": "実行時間regret", "oracleHit": "基準比較",
	...
	EN: {
		...
		"latency": "Latency", "searchWork": "Search work", "selection": "Direction balance", "regret": "Runtime regret", "oracleHit": "Baseline comparison",
	...
	ZH: {
		...
		"latency": "延迟", "searchWork": "搜索工作量", "selection": "前后向比例", "regret": "运行时间后悔值", "oracleHit": "基线比较",
	...
	KO: {
		...
		"latency": "지연 시간", "searchWork": "탐색 작업량", "selection": "양방향 비율", "regret": "실행 시간 regret", "oracleHit": "기준 비교",
	...
	FR: {
		...
		"latency": "Latence", "searchWork": "Travail de recherche", "selection": "Équilibre des directions", "regret": "Regret d’exécution", "oracleHit": "Comparaison de référence",
