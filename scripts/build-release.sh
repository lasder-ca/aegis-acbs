...
QUERIES=100 REPEATS=5 BATCH=8 scripts/compare-tags.sh artifacts/hatfield-uk.aegis artifacts/tag-comparison
...
cp artifacts/tag-comparison/old.html "$DIST/tag-comparison-v0.1.0.html"
cp artifacts/tag-comparison/current.html "$DIST/tag-comparison-v0.2.0.html"
...
info={
  ...
  'tests':'go test ./...','vet':'go vet ./...','benchmark':'Hatfield real OSM-derived fixture, 100 mixed queries, 5 repeated measurements, batch size 8, seed 1010, including ACBS ablations and v0.1/v0.2 tag comparison'
}
